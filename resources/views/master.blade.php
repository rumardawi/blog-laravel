...
<head>
  ...
  <link href="{{asset('frontend_asset/vendor/fontawesome-free/css/all.min.css')}} " rel="stylesheet" type="text/css">
  <link href='https://fonts.googleapis.com/css?family=Lora:400,700,400italic,700italic' rel='stylesheet' type='text/css'>
  <link href='https://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,400,300,600,700,800' rel='stylesheet' type='text/css'>

  <!-- Custom styles for this template -->
  <link href="{{asset('frontend_asset/css/clean-blog.min.css')}}" rel="stylesheet">
...
{{-- Making a Space --}}
  ...
  <script src="{{asset('frontend_asset/js/clean-blog.min.js')}}"></script>
